...
## 2024-05-18 - [Missing AI Input Limits]
**Vulnerability:** The AI gateway invocation passed unvalidated user input directly into system prompts.
**Learning:** Always validate AI inputs' types, bounds, and content.
**Prevention:** Implement explicit schema validation/allowlisting for user inputs bound to prompt generation.
