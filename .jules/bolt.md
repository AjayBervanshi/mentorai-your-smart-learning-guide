...
## 2024-05-31 - Levenshtein Distance Micro-Optimization
**Learning:** In high-frequency code paths like fuzzy search on every keystroke, generating new arrays inside the loop for dynamic programming algorithms causes high GC pressure and memory allocations.
**Action:** When implementing mathematical algorithms executed often, reuse module-level TypedArrays (e.g. `Int32Array`) and basic variable swaps instead of array destructuring, reducing latency significantly.
