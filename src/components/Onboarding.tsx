...
import { Brain, Target, Clock, Sparkles, Plus, X, ChevronRight, Briefcase, TrendingUp, Rocket, Check, Loader2, User } from "lucide-react";
          ...
          <motion.div key={step} initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -30 }} transition={{ duration: 0.3 }}>
            ...
            {step === "skills" && (
              <div className="space-y-6">
                ...
                <div className="flex gap-2" role="group" aria-label="Current skill level">
            ...
            {step === "time" && (
              <div className="space-y-6">
                ...
                <div className="space-y-3" role="group" aria-label="Daily commitment">
                  {([
