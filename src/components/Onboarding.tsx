              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    This helps keep your learning journey separate from others.
                  </p>
                </div>
            ...
            {step === "skills" && (
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Anything — coding, cooking, languages, music, AI, fitness,
                    business, or anything else. Type any skill!
                  </p>
                </div>
                ...
                <div className="relative">
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      onClick={() => addSkill()}
                      size="icon"
                      className="gradient-primary shrink-0 text-primary-foreground h-11 w-11"
                    >
            ...
            {step === "level" && (
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    We'll adjust the roadmap difficulty for each skill based on
                    your selection.
                  </p>
                </div>
                <div className="space-y-3">
            ...
            {step === "goal" && (
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    This helps us personalize your learning path and project
                    suggestions.
                  </p>
                </div>
                <div
                ...
                >
                  {[
                    {
                      value: "job" as UserGoal,
                      icon: Briefcase,
                      title: "Get a Job",
                      desc: "Prepare for interviews and land a role",
                    },
                    {
                      value: "freelance" as UserGoal,
                      icon: Rocket,
                      title: "Freelance",
                      desc: "Start earning independently",
                    },
                    {
                      value: "growth" as UserGoal,
                      icon: TrendingUp,
                      title: "Skill Growth",
                      desc: "Level up for personal development",
                    },
                  ].map((g) => (
                    <button
                      key={g.value}
                    ...
                    >
                      <div
                        className={`w-10 h-10 rounded-xl flex items-center justify-center ${goal === g.value ? "gradient-primary" : "bg-secondary"}`}
                      >
                        <g.icon
                          className={`w-5 h-5 ${goal === g.value ? "text-primary-foreground" : "text-muted-foreground"}`}
                        />
                      </div>
            ...
            {step === "time" && (
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Even 15 minutes daily adds up. Consistency beats intensity.
                  </p>
                </div>
                <div className="space-y-3">
                  {[
                    {
                      value: 15 as DailyTime,
                      label: "15 minutes",
                      desc: "Quick daily sessions — perfect for busy schedules",
                    },
                    {
                      value: 30 as DailyTime,
                      label: "30 minutes",
                      desc: "Recommended — steady, sustainable progress",
                    },
                    {
                      value: 60 as DailyTime,
                      label: "60 minutes",
                      desc: "Deep learning — fastest results",
                    },
                  ].map((t) => (
                    <button
                      key={t.value}
                    ...
                    >
                      <div
                        className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold text-sm ${dailyTime === t.value ? "gradient-primary text-primary-foreground" : "bg-secondary text-muted-foreground"}`}
                      >
                        {t.value}m
                      </div>
                      <div className="flex-1">
