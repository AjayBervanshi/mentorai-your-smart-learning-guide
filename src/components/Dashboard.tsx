...
export default function Dashboard({ onNavigate }: DashboardProps) {
  ...
  // ⚡ Bolt: Memoized expensive array processing to prevent re-calculating
  // every render (e.g. when typing in the 'Add Skill' input).
  const {
    totalProgress,
    totalTopics,
    completedTopics,
    ...
    if (!profile) {
      return { totalProgress: 0, totalTopics: 0, completedTopics: 0, currentSkill: undefined, currentTopic: undefined, weakTopicsList: [] };
    }
    ...
    return { totalProgress, totalTopics, completedTopics, currentSkill, currentTopic, weakTopicsList };
  }, [profile]);
