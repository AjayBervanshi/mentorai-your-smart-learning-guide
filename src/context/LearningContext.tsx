  ...
  const updateSkillProgress = useCallback(
    async (skillId: string, topicId: string, score: number) => {
      ...
      try {
        ...
        // ⚡ Bolt: Parallelize independent Supabase updates and eliminate redundant SELECT queries
        // by deriving intermediate states (progress, streak, XP) directly from local React Context.
        await Promise.all([
          supabase
            .from("user_topics")
