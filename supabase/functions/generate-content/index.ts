...
serve(async (req) => {
  ...
  try {
    ...
    // Security Fix: Input validation to prevent prompt injection and DoS
    ...
    if (subtopics && (!Array.isArray(subtopics) || subtopics.length > 20 || subtopics.some(t => typeof t !== 'string' || t.length > 100))) {
